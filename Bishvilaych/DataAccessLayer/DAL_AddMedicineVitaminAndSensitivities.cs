...
namespace DataAccessLayer
{
    public class DAL_AddMedicineVitaminAndSensitivities
    {
        ...
        public DAL_AddMedicineVitaminAndSensitivities()
        {
        ...
        public DataSet Draw_Medicine(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Draw_Medicine"; //שם הפרוצדורה
        ...
        public DataSet Draw_Vitamina(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Draw_Vitamina"; //שם הפרוצדורה
            DataSet retDataDs = new DataSet(); //הכנת הטבלה אליה יכנסו הנתונים
            string retError;
        ...
        public DataSet Draw_GivenKind(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Draw_GivenKind"; //שם הפרוצדורה
            DataSet retDataDs = new DataSet(); //הכנת הטבלה אליה יכנסו הנתונים
            string retError;
        ...
        public int Add_MedicinesAndVitamins(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Add_MedicinesAndVitamins"; //שם הפרוצדורה

            return db_ctrl.ExecuteNonQueryFunction(connStr, sp_name, ref Params); //החזרת תוצאה
        }

        public int Add_MedicineVitamin(ListDictionary @params)
        {
        ...
        public DataSet Print_ReceiptMV(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Print_ReceiptMV"; //שם הפרוצדורה
            DataSet retDataDs = new DataSet(); //הכנת הטבלה אליה יכנסו הנתונים
            string retError;
        ...
        public DataSet Draw_KindSS(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Draw_KindSS"; //שם הפרוצדורה
            DataSet retDataDs = new DataSet(); //הכנת הטבלה אליה יכנסו הנתונים
            string retError;
        ...
        public int Update_MedicineVitamin(ListDictionary @params)
        {
            throw new NotImplementedException();
        }
        ...
        public DataSet Draw_Influenss(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Draw_Influenss"; //שם הפרוצדורה
            DataSet retDataDs = new DataSet(); //הכנת הטבלה אליה יכנסו הנתונים
            string retError;
        ...
        public int Add_Sensitivities(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "Add_Sensitivities"; //שם הפרוצדורה

            return db_ctrl.ExecuteNonQueryFunction(connStr, sp_name, ref Params); //החזרת תוצאה
        }

        public int Update_Sensitivities(ListDictionary @params)
        {
            throw new NotImplementedException();
        }
    }
