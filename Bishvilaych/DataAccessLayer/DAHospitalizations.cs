...
namespace DataAccessLayer//Ma'ayan
{
     public class DAHospitalizations
    {
        ...
        public DAHospitalizations()
        {
            connStr = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        }

        public DataSet GetAllHspitalization(ListDictionary Params) //קבלת רשימת פרמטרים
        {
        ...
        public DataSet GetNameHospital(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            DBCtrl db_ctrl = new DBCtrl();
            if (!db_ctrl.isConnected())
            {
            ...
            string sp_name = "GetNameHospital"; //שם הפרוצדורה
            DataSet retDataDs = new DataSet(); //הכנת הטבלה אליה יכנסו הנתונים
            string retError;
        ...
        public int DeleteHospitalizations(ListDictionary Params) //קבלת רשימת פרמטרים
        {
            ...
            string sp_name = "DeleteHospitalizations"; //שם הפרוצדורה
